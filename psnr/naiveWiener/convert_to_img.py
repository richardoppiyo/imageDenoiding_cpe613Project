...
# Example usage
input_filename ='input_rgb_values.txt'  # Name of the input file with the RGB values
# input_filename ='outputImage.txt'  # Name of the input file with the RGB values
output_image_path = 'input_image.png'  # Desired path for the reconstructed image
# output_image_path = 'denoised_image.png'  # Desired path for the reconstructed image
